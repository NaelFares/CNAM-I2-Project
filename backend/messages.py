...
MESSAGE_CATALOG = {
    ...
    "RIDE_ALREADY_SELECTED": "Vous avez deja selectionne ce trajet.",
    "RIDE_TIME_CONFLICT": "Vous avez deja reserve un trajet a cette date et a cette heure.",
    "RIDE_FULL": "Ce trajet est complet.",
    "RIDE_SELECTION_SUCCESS": "Trajet selectionne avec succes.",
